...
namespace NetWork.Modelo
{
    public class Reservas
    {
        ...
        public Reservas(int codigoReservas, DateTime fechaEntrada, DateTime fechaSalida, int idCliente, string dniCliente, int numHabitacion, int estadoReserva, string nombreCliente)
        {
