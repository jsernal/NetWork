    ...
    public partial class CreateTables : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Reservas", t => t.CodigoReservas, cascadeDelete: true)
                .Index(t => t.CodigoReservas);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Facturas", "CodigoReservas", "dbo.Reservas");
            ...
            DropIndex("dbo.Facturas", new[] { "CodigoReservas" });
